...
class CharacterMapper @Inject constructor() {
    private fun mapCharacterResponseForInfo(characterInfoResponse: CharacterInfoResponse?) =
        CharacterInfo(
    ...
    private fun mapLocationResponseForLocation(characterLocationResponse: CharacterLocationResponse?) =
        CharacterLocation(
            name = characterLocationResponse?.name ?: EMPTY_STRING,
            url = characterLocationResponse?.url ?: EMPTY_STRING
        )

    fun mapResultResponseForResult(characterResultResponse: CharacterResultResponse?) =
        CharacterResult(
